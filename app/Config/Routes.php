...
// Midtrans Notification Webhook (Exclude from CSRF)
$routes->post('payment/notification', 'PaymentController::notificationHandler');
...
$routes->group('admin', ['filter' => 'auth'], function($routes) {
    ...
    $routes->get('penyewaan/verifikasi/(:num)', 'Admin\Penyewaan::verifikasiDokumen/$1');
    $routes->post('penyewaan/submit-verifikasi/(:num)', 'Admin\Penyewaan::submitVerifikasi/$1');
    $routes->get('penyewaan/download/(:any)/(:num)', 'Admin\Penyewaan::downloadDokumen/$1/$2');
