                ...
                <div class="card booking-card mb-4" id="booking-<?= $request->id_sewa ?>">
                    <div class="position-relative">
                        ...
                        <div class="position-absolute bottom-0 start-0 p-3 text-white">
                            ...
                            <h6 class="fw-bold m-0"><?= esc($request->merk) ?></h6>
                        </div>
                    </div>
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <span class="fw-bold small"><?= esc($request->nama_pelanggan) ?></span>
                            </div>
                            <button class="btn btn-sm btn-outline-info btn-check-doc" 
                                    data-id="<?= $request->id_pelanggan ?>"
                                    data-bs-toggle="modal" 
                                    data-bs-target="#modalDokumen">
                                <i class="bi bi-file-check"></i> Cek Dokumen
                            </button>
                        </div>
                        ...
                        <div class="row g-2">
                            <div class="col-4">
                                <button class="btn btn-outline-danger w-100 fw-bold border-2 btn-reject" 
                                        ...
                                        data-id="<?= $request->id_sewa ?>"
                                        data-nama="<?= esc($request->nama_pelanggan) ?>"
                                        data-merk="<?= esc($request->merk) ?>">
                                    TOLAK
                                </button>
                            </div>
                            <div class="col-8">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="https://ui-avatars.com/api/?name=<?= urlencode($row->nama_pelanggan) ?>&background=0d6efd&color=fff" class="cust-avatar">
                                    <span class="fw-bold"><?= esc($row->nama_pelanggan) ?></span>
                                </div>
                            </td>
                            <td class="text-muted"><?= esc($row->merk) ?></td>
